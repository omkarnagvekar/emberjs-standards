...
Place 1 space before the leading brace, opening parenthesis of conditionals. Place no space between the argument list and the function name in function calls and declarations. 
